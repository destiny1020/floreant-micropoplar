...
public class JCheckBoxList extends JTable {
  ...
  /**
   * Creates a checkbox list with the given list of objects. The elements of this array can either
   * be Entry instances, or other objects (if the latter, they will default to being unchecked).
   */
  ...
  // {{{ JCheckBoxList constructor
  /**
   * Creates a checkbox list with the given list of objects. The elements of this vector can either
   * be Entry instances, or other objects (if the latter, they will default to being unchecked).
   */
  ...
  // {{{ setModel() method
  /**
   * Sets the model to the given list of objects. The elements of this array can either be Entry
   * instances, or other objects (if the latter, they will default to being unchecked).
   */
  ...
  // {{{ setModel() method
  /**
   * Sets the model to the given list of objects. The elements of this vector can either be Entry
   * instances, or other objects (if the latter, they will default to being unchecked).
   */
  ...
  private class DummyRenderer extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
      ...
      return super.getTableCellRendererComponent(table, null /* value */, isSelected,
