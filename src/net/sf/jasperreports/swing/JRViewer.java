...
/*
 * Contributors: Ryan Johnson - delscovich@users.sourceforge.net Carlton Moore -
 * cmoore79@users.sourceforge.net Petr Michalek - pmichalek@users.sourceforge.net
 */
 ...
 * @version $Id: JRViewer.java 3659 2010-03-31 10:20:49Z shertage $
 */
public class JRViewer extends javax.swing.JPanel implements JRViewerListener {
  private static final long serialVersionUID = JRConstants.SERIAL_VERSION_UID;

  /**
   * Maximum size (in pixels) of a buffered image that would be used by {@link JRViewer JRViewer} to
   * render a report page.
   * <p>
   * If rendering a report page would require an image larger than this threshold (i.e. image width
   * x image height > maximum size), the report page will be rendered directly on the viewer
   * component.
   * </p>
   * <p>
   * If this property is zero or negative, buffered images will never be user to render a report
   * page. By default, this property is set to 0.
   * </p>
   */
  public static final String VIEWER_RENDER_BUFFER_MAX_SIZE =
      JRProperties.PROPERTY_PREFIX + "viewer.render.buffer.max.size";
