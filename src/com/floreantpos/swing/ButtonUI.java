...
public class ButtonUI extends PlasticButtonUI {
   ...
   * directives throughout the code.
   */
  ...
  private static void add3DEffekt(Graphics g, Rectangle r, boolean isHorizontal, Color startC0,
      Color stopC0, Color startC1, Color stopC1) {
  ...
  static void add3DEffekt(Graphics g, Rectangle r) {
    ...
    int border = 10;
    g2.setPaint(
        new GradientPaint(r.x, r.y, brightenStop, r.x + border, r.y, PlasticTheme.BRIGHTEN_START));
    g2.fillRect(r.x, r.y, border, r.height);
    int x = r.x + r.width - border;
    int y = r.y;
    g2.setPaint(new GradientPaint(x, y, PlasticTheme.DARKEN_START, x + border, y,
  ...
  static void addLight3DEffekt(Graphics g, Rectangle r, boolean isHorizontal) {
    ...
    add3DEffekt(g, r, isHorizontal, PlasticTheme.BRIGHTEN_START, ltBrightenStop,
        PlasticTheme.DARKEN_START, PlasticTheme.LT_DARKEN_STOP);
  }
  ...
  public static void addLight3DEffekt(Graphics g, Rectangle r) {
    ...
    add3DEffekt(g, r, true, PlasticTheme.DARKEN_START, PlasticTheme.LT_DARKEN_STOP,
        PlasticTheme.BRIGHTEN_START, ltBrightenStop);
  }
