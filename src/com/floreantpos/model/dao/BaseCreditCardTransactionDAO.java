...
public abstract class BaseCreditCardTransactionDAO extends com.floreantpos.model.dao._RootDAO {
  ...
  public com.floreantpos.model.CreditCardTransaction loadInitialize(java.lang.Integer key,
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.CreditCardTransaction> findAll(Session s,
      Order defaultOrder) {
