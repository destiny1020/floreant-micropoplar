...
public abstract class BaseTicketItemModifierGroupDAO extends com.floreantpos.model.dao._RootDAO {
  ...
  public static TicketItemModifierGroupDAO getInstance() {
    if (null == instance)
      instance = new TicketItemModifierGroupDAO();
    return instance;
  }
  ...
  public com.floreantpos.model.TicketItemModifierGroup loadInitialize(java.lang.Integer key,
      Session s) {
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.TicketItemModifierGroup> findAll(Session s,
      Order defaultOrder) {
   ...
   */
  public java.lang.Integer save(
      com.floreantpos.model.TicketItemModifierGroup ticketItemModifierGroup, Session s) {
   ...
   * </ul>
   */
  public void refresh(com.floreantpos.model.TicketItemModifierGroup ticketItemModifierGroup,
      Session s) {
