...
public abstract class BaseUserPermissionDAO extends com.floreantpos.model.dao._RootDAO {
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.UserPermission> findAll(Session s,
      Order defaultOrder) {
   ...
   * 
   * @param userPermission a transient instance of a persistent class
   * @return the class identifier
   */
  public java.lang.String save(com.floreantpos.model.UserPermission userPermission) {
   ...
   * @return the class identifier
   */
  public java.lang.String save(com.floreantpos.model.UserPermission userPermission, Session s) {
   ...
   * 
   * @param userPermission a transient instance containing new or updated state
   */
  public void saveOrUpdate(com.floreantpos.model.UserPermission userPermission) {
   ...
   * @param s the Session.
   */
  public void saveOrUpdate(com.floreantpos.model.UserPermission userPermission, Session s) {
   ...
   * 
   * @param userPermission a transient instance containing updated state
   */
  public void update(com.floreantpos.model.UserPermission userPermission) {
   ...
   * @param the Session
   */
  public void update(com.floreantpos.model.UserPermission userPermission, Session s) {
   ...
   * persistent state.
   * 
   * @param userPermission the instance to be removed
   */
  public void delete(com.floreantpos.model.UserPermission userPermission) {
   ...
   * @param s the Session
   */
  public void delete(com.floreantpos.model.UserPermission userPermission, Session s) {
    delete((Object) userPermission, s);
  }
   ...
   * </ul>
   */
  public void refresh(com.floreantpos.model.UserPermission userPermission, Session s) {
