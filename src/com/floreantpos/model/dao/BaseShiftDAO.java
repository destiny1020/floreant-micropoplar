 ...
 */
public abstract class BaseShiftDAO extends com.floreantpos.model.dao._RootDAO {
  ...
  public Class getReferenceClass() {
    return com.floreantpos.model.Shift.class;
  }
  ...
  /**
   * Cast the object as a com.floreantpos.model.Shift
   */
  public com.floreantpos.model.Shift cast(Object object) {
    return (com.floreantpos.model.Shift) object;
  }

  public com.floreantpos.model.Shift get(java.lang.Integer key) {
    return (com.floreantpos.model.Shift) get(getReferenceClass(), key);
  }

  public com.floreantpos.model.Shift get(java.lang.Integer key, Session s) {
    return (com.floreantpos.model.Shift) get(getReferenceClass(), key, s);
  }

  public com.floreantpos.model.Shift load(java.lang.Integer key) {
    return (com.floreantpos.model.Shift) load(getReferenceClass(), key);
  }

  public com.floreantpos.model.Shift load(java.lang.Integer key, Session s) {
    return (com.floreantpos.model.Shift) load(getReferenceClass(), key, s);
  }

  public com.floreantpos.model.Shift loadInitialize(java.lang.Integer key, Session s) {
    com.floreantpos.model.Shift obj = load(key, s);
   ...
   */
  public java.util.List<com.floreantpos.model.Shift> findAll() {
   ...
   * Return all objects related to the implementation of this DAO with no filter.
   */
  public java.util.List<com.floreantpos.model.Shift> findAll(Order defaultOrder) {
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.Shift> findAll(Session s, Order defaultOrder) {
   ...
   */
  public java.lang.Integer save(com.floreantpos.model.Shift shift) {
   ...
   * @return the class identifier
   */
  public java.lang.Integer save(com.floreantpos.model.Shift shift, Session s) {
   ...
   */
  public void saveOrUpdate(com.floreantpos.model.Shift shift) {
   ...
   * @param s the Session.
   */
  public void saveOrUpdate(com.floreantpos.model.Shift shift, Session s) {
   ...
   */
  public void update(com.floreantpos.model.Shift shift) {
    update((Object) shift);
  }
   ...
   * @param the Session
   */
  public void update(com.floreantpos.model.Shift shift, Session s) {
   ...
   */
  public void delete(com.floreantpos.model.Shift shift) {
    delete((Object) shift);
  }
   ...
   * @param s the Session
   */
  public void delete(com.floreantpos.model.Shift shift, Session s) {
   ...
   * </ul>
   */
  public void refresh(com.floreantpos.model.Shift shift, Session s) {
