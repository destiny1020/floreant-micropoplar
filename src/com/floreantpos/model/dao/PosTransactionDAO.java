...
public class PosTransactionDAO extends BasePosTransactionDAO {
  ...
  public List<PosTransaction> findUnauthorizedTransactions(User owner) {
    ...
    try {
      ...
      criteria.add(
          Restrictions.eq(PosTransaction.PROP_TRANSACTION_TYPE, TransactionType.CREDIT.name()));
  ...
  public List<? extends PosTransaction> findTransactions(Terminal terminal, Class transactionClass,
      Date from, Date to) {
    Session session = null;
