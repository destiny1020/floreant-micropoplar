...
public abstract class BaseUserDAO extends com.floreantpos.model.dao._RootDAO {
   ...
   */
  public void update(com.floreantpos.model.User user) throws org.hibernate.HibernateException {
    update((Object) user);
  }
   ...
   */
  public void delete(com.floreantpos.model.User user) throws org.hibernate.HibernateException {
    delete((Object) user);
  }
