...
public class TerminalDAO extends BaseTerminalDAO {
  ...
  public void resetCashDrawer(DrawerPullReport report, Terminal terminal, User user)
      throws Exception {
    Session session = null;
    Transaction tx = null;
    ...
    try {
      ...
      String hql = "update Ticket t set t.drawerResetted=true where t." + Ticket.PROP_CLOSED
          + "=true and t.drawerResetted=false and t.terminal=:terminal";
      Query query = session.createQuery(hql);
      query.setEntity("terminal", terminal);
      query.executeUpdate();

      hql =
          "update PosTransaction t set t.drawerResetted=true where t.drawerResetted=false and t.terminal=:terminal";
