...
public abstract class BasePrinterConfigurationDAO extends com.floreantpos.model.dao._RootDAO {
  ...
  public com.floreantpos.model.PrinterConfiguration loadInitialize(java.lang.Integer key,
      Session s) {
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.PrinterConfiguration> findAll(Session s,
      Order defaultOrder) {
