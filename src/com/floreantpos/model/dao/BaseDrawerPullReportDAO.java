 ...
 */
public abstract class BaseDrawerPullReportDAO extends com.floreantpos.model.dao._RootDAO {
  ...
  public Class getReferenceClass() {
    return com.floreantpos.model.DrawerPullReport.class;
  }
  ...
  /**
   * Cast the object as a com.floreantpos.model.DrawerPullReport
   */
  public com.floreantpos.model.DrawerPullReport cast(Object object) {
    return (com.floreantpos.model.DrawerPullReport) object;
  }
   ...
   */
  public java.util.List<com.floreantpos.model.DrawerPullReport> findAll() {
   ...
   * Return all objects related to the implementation of this DAO with no filter.
   */
  public java.util.List<com.floreantpos.model.DrawerPullReport> findAll(Order defaultOrder) {
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.DrawerPullReport> findAll(Session s,
      Order defaultOrder) {
