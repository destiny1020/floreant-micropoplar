...
public class AttendenceHistoryDAO extends BaseAttendenceHistoryDAO {
  ...
  public List<User> findNumberOfClockedInUserAtHour(Date fromDay, Date toDay, int hour,
  ...
  public List<User> findNumberOfClockedInUserAtShift(Date fromDay, Date toDay, Shift shift,
      String userType, Terminal terminal) {
    Session session = null;
  ...
  public AttendenceHistory findHistoryByClockedInTime(User user) {
    ...
    try {
      ...
      criteria
          .add(Restrictions.eq(AttendenceHistory.PROP_CLOCK_IN_TIME, user.getLastClockInTime()));
