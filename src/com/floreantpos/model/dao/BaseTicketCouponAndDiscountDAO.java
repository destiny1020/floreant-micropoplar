...
public abstract class BaseTicketCouponAndDiscountDAO extends com.floreantpos.model.dao._RootDAO {
  ...
  public static TicketCouponAndDiscountDAO getInstance() {
    if (null == instance)
      instance = new TicketCouponAndDiscountDAO();
    return instance;
  }
  ...
  public com.floreantpos.model.TicketCouponAndDiscount loadInitialize(java.lang.Integer key,
      Session s) {
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.TicketCouponAndDiscount> findAll(Session s,
      Order defaultOrder) {
   ...
   */
  public java.lang.Integer save(
      com.floreantpos.model.TicketCouponAndDiscount ticketCouponAndDiscount, Session s) {
   ...
   * </ul>
   */
  public void refresh(com.floreantpos.model.TicketCouponAndDiscount ticketCouponAndDiscount,
      Session s) {
