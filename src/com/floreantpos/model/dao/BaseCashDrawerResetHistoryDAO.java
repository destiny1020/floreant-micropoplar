...
public abstract class BaseCashDrawerResetHistoryDAO extends com.floreantpos.model.dao._RootDAO {
  ...
  public com.floreantpos.model.CashDrawerResetHistory loadInitialize(java.lang.Integer key,
      Session s) {
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.CashDrawerResetHistory> findAll(Session s,
      Order defaultOrder) {
  ...
  public java.lang.Integer save(
      com.floreantpos.model.CashDrawerResetHistory cashDrawerResetHistory) {
   ...
   * </ul>
   */
  public void refresh(com.floreantpos.model.CashDrawerResetHistory cashDrawerResetHistory,
      Session s) {
