 ...
 */
public abstract class BaseCookingInstructionDAO extends com.floreantpos.model.dao._RootDAO {
  ...
  public Class getReferenceClass() {
    return com.floreantpos.model.CookingInstruction.class;
  }
  ...
  /**
   * Cast the object as a com.floreantpos.model.CookingInstruction
   */
  public com.floreantpos.model.CookingInstruction cast(Object object) {
    return (com.floreantpos.model.CookingInstruction) object;
  }

  public com.floreantpos.model.CookingInstruction get(java.lang.Integer key) {
    return (com.floreantpos.model.CookingInstruction) get(getReferenceClass(), key);
  }

  public com.floreantpos.model.CookingInstruction get(java.lang.Integer key, Session s) {
    return (com.floreantpos.model.CookingInstruction) get(getReferenceClass(), key, s);
  }

  public com.floreantpos.model.CookingInstruction load(java.lang.Integer key) {
    return (com.floreantpos.model.CookingInstruction) load(getReferenceClass(), key);
  }

  public com.floreantpos.model.CookingInstruction load(java.lang.Integer key, Session s) {
    return (com.floreantpos.model.CookingInstruction) load(getReferenceClass(), key, s);
  }

  public com.floreantpos.model.CookingInstruction loadInitialize(java.lang.Integer key, Session s) {
    com.floreantpos.model.CookingInstruction obj = load(key, s);
   ...
   */
  public java.util.List<com.floreantpos.model.CookingInstruction> findAll() {
   ...
   * Return all objects related to the implementation of this DAO with no filter.
   */
  public java.util.List<com.floreantpos.model.CookingInstruction> findAll(Order defaultOrder) {
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.CookingInstruction> findAll(Session s,
      Order defaultOrder) {
