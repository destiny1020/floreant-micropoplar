...
public abstract class BaseInventoryTransactionDAO
  ...
  public com.floreantpos.model.inventory.InventoryTransaction loadInitialize(java.lang.Integer key,
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.inventory.InventoryTransaction> findAll(Session s,
      Order defaultOrder) {
   ...
   */
  public java.lang.Integer save(
      com.floreantpos.model.inventory.InventoryTransaction inventoryTransaction, Session s)
          throws org.hibernate.HibernateException {
   ...
   * </ul>
   */
  public void refresh(com.floreantpos.model.inventory.InventoryTransaction inventoryTransaction,
      Session s) throws org.hibernate.HibernateException {
