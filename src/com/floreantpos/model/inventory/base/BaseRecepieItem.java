...
/**
 * This is an object that contains data related to the RECEPIE_ITEM table. Do not modify this class
...
public abstract class BaseRecepieItem implements Comparable, Serializable {
   ...
   */
  public BaseRecepieItem(java.lang.Integer id, com.floreantpos.model.inventory.Recepie recepie) {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.inventory.RecepieItem))
      return false;
    else {
      com.floreantpos.model.inventory.RecepieItem recepieItem =
          (com.floreantpos.model.inventory.RecepieItem) obj;
