 ...
 */
public abstract class BaseInventoryTransactionTypeDAO
    extends com.floreantpos.model.inventory.dao._RootDAO {

  // query name references


  public static InventoryTransactionTypeDAO instance;

  /**
   * Return a singleton of the DAO
   */
  public static InventoryTransactionTypeDAO getInstance() {
    if (null == instance)
      instance = new InventoryTransactionTypeDAO();
    return instance;
  }

  public Class getReferenceClass() {
    return com.floreantpos.model.inventory.InventoryTransactionType.class;
  }
  ...
  /**
   * Cast the object as a com.floreantpos.model.inventory.InventoryTransactionType
   */
  public com.floreantpos.model.inventory.InventoryTransactionType cast(Object object) {
    return (com.floreantpos.model.inventory.InventoryTransactionType) object;
  }
  ...
  public com.floreantpos.model.inventory.InventoryTransactionType load(java.lang.Integer key) {
    return (com.floreantpos.model.inventory.InventoryTransactionType) load(getReferenceClass(),
        key);
  }
  ...
  public com.floreantpos.model.inventory.InventoryTransactionType loadInitialize(
   ...
   */
  public java.util.List<com.floreantpos.model.inventory.InventoryTransactionType> findAll() {
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.inventory.InventoryTransactionType> findAll(Session s,
      Order defaultOrder) {
   ...
   * 
   * @param inventoryTransactionType a transient instance of a persistent class
