...
public abstract class BaseInventoryLocationDAO
  ...
  public com.floreantpos.model.inventory.InventoryLocation loadInitialize(java.lang.Integer key,
      Session s) {
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.inventory.InventoryLocation> findAll(Session s,
      Order defaultOrder) {
   ...
   * </ul>
   */
  public void refresh(com.floreantpos.model.inventory.InventoryLocation inventoryLocation,
      Session s) {
