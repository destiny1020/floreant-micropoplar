...
public abstract class BasePurchaseOrderDAO extends com.floreantpos.model.inventory.dao._RootDAO {
  ...
  public com.floreantpos.model.inventory.PurchaseOrder loadInitialize(java.lang.Integer key,
      Session s) {
   ...
   * @param s the Session
   */
  public java.util.List<com.floreantpos.model.inventory.PurchaseOrder> findAll(Session s,
      Order defaultOrder) {
