...
/**
 * This is an object that contains data related to the RECEPIE table. Do not modify this class
 * because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="RECEPIE"
 */
...
public abstract class BaseRecepie implements Comparable, Serializable {
   ...
   */
  public void setRecepieItems(
      java.util.Set<com.floreantpos.model.inventory.RecepieItem> recepieItems) {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.inventory.Recepie))
      return false;
    else {
      com.floreantpos.model.inventory.Recepie recepie =
          (com.floreantpos.model.inventory.Recepie) obj;
