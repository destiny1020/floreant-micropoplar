...
/**
 * This is an object that contains data related to the INVENTORY_META_CODE table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="INVENTORY_META_CODE"
 */
...
public abstract class BaseInventoryMetaCode implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.inventory.InventoryMetaCode))
      return false;
    else {
      com.floreantpos.model.inventory.InventoryMetaCode inventoryMetaCode =
          (com.floreantpos.model.inventory.InventoryMetaCode) obj;
