...
public abstract class _BaseRootDAO {
  ...
  public static void initialize() {
    com.floreantpos.model.inventory.dao._RootDAO.initialize((String) null);
  }
  ...
  public static void initialize(String configFileName) {
    com.floreantpos.model.inventory.dao._RootDAO.initialize(configFileName,
        com.floreantpos.model.inventory.dao._RootDAO.getNewConfiguration(null));
  }
  ...
  public static void initialize(String configFileName, Configuration configuration) {
    if (null == configFileName && null != sessionFactory)
      ...
      if (null == configFileName) {
        ...
        com.floreantpos.model.inventory.dao._RootDAO
            .setSessionFactory(configuration.buildSessionFactory());
      } else {
        configuration.configure(configFileName);
        com.floreantpos.model.inventory.dao._RootDAO.setSessionFactory(configFileName,
  ...
  /**
   * Return the SessionFactory that is to be used by these DAOs. Change this and implement your own
   * strategy if you, for example, want to pull the SessionFactory from the JNDI tree.
   */
   ...
   * Return a new Session object that must be closed when the work has been completed.
   * 
   * @param configFile the config file must match the meta attribute "config-file" in the hibernate
   *        mapping file
   * @return the active Session
   */
  ...
  /**
   * Return a new Configuration to use. This is not a mistake and is meant to be overridden in the
   * RootDAO if you want to do something different. The file name is passed in so you have that to
   * access. The config file is read in the initialize method.
   */
  ...
  /**
   * Used by the base DAO classes but here for your modification Get object matching the given key
   * and return it.
   */
  ...
  /**
   * Used by the base DAO classes but here for your modification Load object matching the given key
   * and return it.
   */
  ...
  /**
   * Return all objects related to the implementation of this DAO with a filter. Use the session
   * given.
   * 
  ...
  /**
   * Obtain an instance of Query for a named query string defined in the mapping file. Use the
   * session given.
   * 
   * @param name the name of a query defined externally
   * @param s the Session
  ...
  /**
   * Obtain an instance of Query for a named query string defined in the mapping file. Use the
   * parameters given and the Session given.
   * 
   * @param name the name of a query defined externally
   * @param params the parameter array
   * @s the Session
  ...
  /**
   * Used by the base DAO classes but here for your modification Persist the given transient
   * instance, first assigning a generated identifier. (Or using the current value of the identifier
   * property if the assigned generator is used.)
   */
  ...
  /**
   * Used by the base DAO classes but here for your modification Either save() or update() the given
   * instance, depending upon the value of its identifier property.
   */
  ...
  /**
   * Used by the base DAO classes but here for your modification Update the persistent state
   * associated with the given identifier. An exception is thrown if there is a persistent instance
   * with the same identifier in the current session.
   * 
  ...
  /**
   * Used by the base DAO classes but here for your modification Remove a persistent instance from
   * the datastore. The argument may be an instance associated with the receiving Session or a
  ...
  /**
   * Used by the base DAO classes but here for your modification Re-read the state of the given
   * instance from the underlying database. It is inadvisable to use this to implement long-running
   * sessions that span many business tasks. This method is, however, useful in certain special
   * circumstances.
   */
   ...
   */
  public abstract class TransactionRunnableFailHandler extends TransactionRunnable
  ...
  public class TransactionPointer {
    ...
    /**
     * Wait until the transaction completes and return the value returned from the run method of the
     * TransactionRunnable. If the transaction throws an Exception, throw that Exception.
     * 
     * @param timeout the timeout in milliseconds (or 0 for no timeout)
     * @return the return value from the TransactionRunnable
     * @throws TimeLimitExcededException if the timeout has been reached before transaction
     *         completion
