...
/**
 * This is an object that contains data related to the INVENTORY_UNIT table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="INVENTORY_UNIT"
 */
...
public abstract class BaseInventoryUnit implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.inventory.InventoryUnit))
      return false;
    else {
      com.floreantpos.model.inventory.InventoryUnit inventoryUnit =
          (com.floreantpos.model.inventory.InventoryUnit) obj;
