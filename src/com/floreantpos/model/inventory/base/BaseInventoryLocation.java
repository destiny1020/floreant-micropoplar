...
/**
 * This is an object that contains data related to the INVENTORY_LOCATION table. Do not modify this
...
public abstract class BaseInventoryLocation implements Comparable, Serializable {
   ...
   */
  public BaseInventoryLocation(java.lang.Integer id, java.lang.String name) {
   ...
   */
  public void setWarehouse(com.floreantpos.model.inventory.InventoryWarehouse warehouse) {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.inventory.InventoryLocation))
      return false;
    else {
      com.floreantpos.model.inventory.InventoryLocation inventoryLocation =
          (com.floreantpos.model.inventory.InventoryLocation) obj;
