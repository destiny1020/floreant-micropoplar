...
/**
 * This is an object that contains data related to the PRINTER_CONFIGURATION table. Do not modify
 * this class because it will be overwritten if the configuration file related to this class is
 * modified.
 *
 * @hibernate.class table="PRINTER_CONFIGURATION"
 */
...
public abstract class BasePrinterConfiguration implements Comparable, Serializable {
  ...
  public java.lang.Boolean isPrintRecreiptWhenTicketSettled() {
    return printRecreiptWhenTicketSettled == null ? Boolean.valueOf(true)
        : printRecreiptWhenTicketSettled;
  }
  ...
  public java.lang.Boolean isPrintKitchenWhenTicketSettled() {
    return printKitchenWhenTicketSettled == null ? Boolean.valueOf(true)
        : printKitchenWhenTicketSettled;
  }
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.PrinterConfiguration))
      return false;
    else {
      com.floreantpos.model.PrinterConfiguration printerConfiguration =
          (com.floreantpos.model.PrinterConfiguration) obj;
