...
/**
 * This is an object that contains data related to the VOID_REASONS table. Do not modify this class
 * because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="VOID_REASONS"
 */
...
public abstract class BaseVoidReason implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.VoidReason))
      return false;
    else {
