...
/**
 * This is an object that contains data related to the MENU_CATEGORY table. Do not modify this class
...
public abstract class BaseMenuCategory implements Comparable, Serializable {
   ...
   */
  public BaseMenuCategory(java.lang.Integer id, java.lang.String name) {
  ...
  public void addTomenuGroups(com.floreantpos.model.MenuGroup menuGroup) {
    if (null == getMenuGroups())
      setMenuGroups(new java.util.TreeSet<com.floreantpos.model.MenuGroup>());
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.MenuCategory))
      return false;
    else {
