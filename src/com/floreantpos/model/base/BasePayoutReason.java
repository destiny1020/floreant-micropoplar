...
/**
 * This is an object that contains data related to the PAYOUT_REASONS table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="PAYOUT_REASONS"
 */
...
public abstract class BasePayoutReason implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.PayoutReason))
      return false;
    else {
