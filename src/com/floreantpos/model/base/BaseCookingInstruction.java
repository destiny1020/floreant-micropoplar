...
/**
 * This is an object that contains data related to the COOKING_INSTRUCTION table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="COOKING_INSTRUCTION"
 */
...
public abstract class BaseCookingInstruction implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.CookingInstruction))
      return false;
    else {
      com.floreantpos.model.CookingInstruction cookingInstruction =
          (com.floreantpos.model.CookingInstruction) obj;
