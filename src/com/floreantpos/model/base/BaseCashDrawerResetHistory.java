...
/**
 * This is an object that contains data related to the CASH_DRAWER_RESET_HISTORY table. Do not
 * modify this class because it will be overwritten if the configuration file related to this class
 * is modified.
 *
 * @hibernate.class table="CASH_DRAWER_RESET_HISTORY"
 */
...
public abstract class BaseCashDrawerResetHistory implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.CashDrawerResetHistory))
      return false;
    else {
      com.floreantpos.model.CashDrawerResetHistory cashDrawerResetHistory =
          (com.floreantpos.model.CashDrawerResetHistory) obj;
