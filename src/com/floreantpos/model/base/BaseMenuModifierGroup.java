...
/**
 * This is an object that contains data related to the MENU_MODIFIER_GROUP table. Do not modify this
...
public abstract class BaseMenuModifierGroup implements Comparable, Serializable {
  ...
  public void addTomodifiers(com.floreantpos.model.MenuModifier menuModifier) {
    if (null == getModifiers())
      setModifiers(new java.util.TreeSet<com.floreantpos.model.MenuModifier>());
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.MenuModifierGroup))
      return false;
    else {
      com.floreantpos.model.MenuModifierGroup menuModifierGroup =
          (com.floreantpos.model.MenuModifierGroup) obj;
