...
/**
 * This is an object that contains data related to the ACTION_HISTORY table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="ACTION_HISTORY"
 */
...
public abstract class BaseActionHistory implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.ActionHistory))
      return false;
    else {
