...
/**
 * This is an object that contains data related to the KITCHEN_TICKET table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="KITCHEN_TICKET"
 */
...
public abstract class BaseKitchenTicket implements Comparable, Serializable {
  ...
  public void addToticketItems(com.floreantpos.model.KitchenTicketItem kitchenTicketItem) {
    if (null == getTicketItems())
      setTicketItems(new java.util.ArrayList<com.floreantpos.model.KitchenTicketItem>());
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.KitchenTicket))
      return false;
    else {
