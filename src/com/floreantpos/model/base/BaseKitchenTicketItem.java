...
/**
 * This is an object that contains data related to the KITCHEN_TICKET_ITEM table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="KITCHEN_TICKET_ITEM"
 */
...
public abstract class BaseKitchenTicketItem implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.KitchenTicketItem))
      return false;
    else {
      com.floreantpos.model.KitchenTicketItem kitchenTicketItem =
          (com.floreantpos.model.KitchenTicketItem) obj;
