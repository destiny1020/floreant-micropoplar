...
/**
 * This is an object that contains data related to the COUPON table. Do not modify this
...
public abstract class BaseCoupon implements Comparable, Serializable {
   ...
   */
  public BaseCoupon(java.lang.Integer id) {
    this.setId(id);
    initialize();
  }
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.Coupon))
      return false;
    else {
      com.floreantpos.model.Coupon coupon = (com.floreantpos.model.Coupon) obj;
      if (null == this.getId() || null == coupon.getId())
        return false;
      else
        return (this.getId().equals(coupon.getId()));
    }
  }
