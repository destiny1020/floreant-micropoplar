...
/**
 * This is an object that contains data related to the MENU_ITEM_SHIFT table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="MENU_ITEM_SHIFT"
 */
...
public abstract class BaseMenuItemShift implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.MenuItemShift))
      return false;
    else {
