...
/**
 * This is an object that contains data related to the ATTENDENCE_HISTORY table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="ATTENDENCE_HISTORY"
 */
...
public abstract class BaseAttendenceHistory implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.AttendenceHistory))
      return false;
    else {
      com.floreantpos.model.AttendenceHistory attendenceHistory =
          (com.floreantpos.model.AttendenceHistory) obj;
