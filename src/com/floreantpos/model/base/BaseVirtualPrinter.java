...
/**
 * This is an object that contains data related to the VIRTUAL_PRINTER table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="VIRTUAL_PRINTER"
 */
...
public abstract class BaseVirtualPrinter implements Comparable, Serializable {
   ...
   */
  public BaseVirtualPrinter(java.lang.Integer id, java.lang.String name) {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.VirtualPrinter))
      return false;
    else {
      com.floreantpos.model.VirtualPrinter virtualPrinter =
          (com.floreantpos.model.VirtualPrinter) obj;
