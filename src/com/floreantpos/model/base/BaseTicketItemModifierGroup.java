...
/**
 * This is an object that contains data related to the TICKETITEM_MODIFIERGROUP table. Do not modify
 * this class because it will be overwritten if the configuration file related to this class is
 * modified.
 *
 * @hibernate.class table="TICKETITEM_MODIFIERGROUP"
 */
...
public abstract class BaseTicketItemModifierGroup implements Comparable, Serializable {
   ...
   */
  public void setTicketItemModifiers(
      java.util.List<com.floreantpos.model.TicketItemModifier> ticketItemModifiers) {
    this.ticketItemModifiers = ticketItemModifiers;
  }

  public void addToticketItemModifiers(
      com.floreantpos.model.TicketItemModifier ticketItemModifier) {
    if (null == getTicketItemModifiers())
      setTicketItemModifiers(new java.util.ArrayList<com.floreantpos.model.TicketItemModifier>());
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.TicketItemModifierGroup))
      return false;
    else {
      com.floreantpos.model.TicketItemModifierGroup ticketItemModifierGroup =
          (com.floreantpos.model.TicketItemModifierGroup) obj;
      if (null == this.getId() || null == ticketItemModifierGroup.getId())
        return false;
      else
        return (this.getId().equals(ticketItemModifierGroup.getId()));
    }
  }
