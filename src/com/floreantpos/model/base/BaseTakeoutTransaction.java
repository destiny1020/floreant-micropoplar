...
public class BaseTakeoutTransaction extends com.floreantpos.model.PosTransaction implements Comparable, Serializable {

	public static String REF = "TakeouttTransaction";
	public static String PROP_ID = "id";

	// constructors
	public BaseTakeoutTransaction() {
		initialize();
	}
	 ...
	 */
	public BaseTakeoutTransaction(java.lang.Integer id) {
		super(id);
	}
