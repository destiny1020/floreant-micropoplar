...
/**
 * This is an object that contains data related to the PAYOUT_RECEPIENTS table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="PAYOUT_RECEPIENTS"
 */
...
public abstract class BasePayoutRecepient implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.PayoutRecepient))
      return false;
    else {
      com.floreantpos.model.PayoutRecepient payoutRecepient =
          (com.floreantpos.model.PayoutRecepient) obj;
