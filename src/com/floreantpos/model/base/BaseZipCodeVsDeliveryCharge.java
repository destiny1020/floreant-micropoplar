...
/**
 * This is an object that contains data related to the ZIP_CODE_VS_DELIVERY_CHARGE table. Do not
 * modify this class because it will be overwritten if the configuration file related to this class
 * is modified.
 *
 * @hibernate.class table="ZIP_CODE_VS_DELIVERY_CHARGE"
 */
...
public abstract class BaseZipCodeVsDeliveryCharge implements Comparable, Serializable {
   ...
   */
  public BaseZipCodeVsDeliveryCharge(java.lang.Integer id, java.lang.String zipCode,
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.ZipCodeVsDeliveryCharge))
      return false;
    else {
      com.floreantpos.model.ZipCodeVsDeliveryCharge zipCodeVsDeliveryCharge =
          (com.floreantpos.model.ZipCodeVsDeliveryCharge) obj;
