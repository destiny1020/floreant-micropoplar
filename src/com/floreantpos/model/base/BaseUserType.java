...
/**
 * This is an object that contains data related to the USER_TYPE table. Do not modify this class
 * because it will be overwritten if the configuration file related to this class is modified.
 *
 * @hibernate.class table="USER_TYPE"
 */
...
public abstract class BaseUserType implements Comparable, Serializable {
  ...
  public void addTopermissions(com.floreantpos.model.UserPermission userPermission) {
    if (null == getPermissions())
      setPermissions(new java.util.TreeSet<com.floreantpos.model.UserPermission>());
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.UserType))
      return false;
    else {
