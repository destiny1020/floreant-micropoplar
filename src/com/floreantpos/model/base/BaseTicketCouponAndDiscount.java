...
/**
 * This is an object that contains data related to the TICKET_COUPON_DISCOUNT table. Do not modify
 * this class because it will be overwritten if the configuration file related to this class is
 * modified.
 *
 * @hibernate.class table="TICKET_COUPON_DISCOUNT"
 */
...
public abstract class BaseTicketCouponAndDiscount implements Comparable, Serializable {
  ...
  public boolean equals(Object obj) {
    if (null == obj)
      return false;
    if (!(obj instanceof com.floreantpos.model.TicketCouponAndDiscount))
      return false;
    else {
      com.floreantpos.model.TicketCouponAndDiscount ticketCouponAndDiscount =
          (com.floreantpos.model.TicketCouponAndDiscount) obj;
      if (null == this.getId() || null == ticketCouponAndDiscount.getId())
        return false;
      else
        return (this.getId().equals(ticketCouponAndDiscount.getId()));
    }
  }
