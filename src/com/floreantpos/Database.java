...
public enum Database {
  ...
  // return AppConfig.getString(POSUtil.escapePropertyKey(getEngineName()) + ".host", "localhost");
  // //$NON-NLS-1$ //$NON-NLS-2$
  // }
  //
  ...
  // return AppConfig.getString(POSUtil.escapePropertyKey(getEngineName()) + ".port",
  // getDefaultPort()); //$NON-NLS-1$
  // }
  //
  ...
  // return AppConfig.getString(POSUtil.escapePropertyKey(getEngineName()) + ".dbname", "posdb");
  // //$NON-NLS-1$ //$NON-NLS-2$
  // }
  //
  ...
  // return AppConfig.getString(POSUtil.escapePropertyKey(getEngineName()) + ".user", "app");
  // //$NON-NLS-1$ //$NON-NLS-2$
  // }
  //
  ...
  // return AppConfig.getString(POSUtil.escapePropertyKey(getEngineName()) + ".pass", "sa");
  // //$NON-NLS-1$ //$NON-NLS-2$
  // }
}
