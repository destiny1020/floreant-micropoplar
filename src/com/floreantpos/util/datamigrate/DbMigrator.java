...
public class DbMigrator {
   ...
   * Tables to migrate:
   * 
   * 1. TERMINAL 2. USERS 3. TAX 4. MENU_CATEGORY 5. MENU_GROUP 6. MENU_MODIFIER 7.
   * MENU_MODIFIER_GROUP 8. MENU_ITEM 9. MENU_ITEM_SHIFT 10. RESTAURANT 11. USER_TYPE 12.
   * USER_PERMISSION 13. SHIFT
   * 
   * 
   * @param args
   * @throws Exception
