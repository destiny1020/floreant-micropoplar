...
public class DrawerPullConfigurationView extends ConfigurationView {
  ...
  public DrawerPullConfigurationView() {
    ...
    add(chkAutoDrawerPull =
        new JCheckBox(com.floreantpos.POSConstants.AUTO_DRAWER_PULL_EVERY_DAY_AT_), "wrap, span"); //$NON-NLS-1$
  ...
  public boolean save() throws Exception {
    ...
    JOptionPane.showMessageDialog(this,
        Messages.getString("DrawerPullConfigurationView.RESTART_MESSAGE")); //$NON-NLS-1$
    return true;
  }
