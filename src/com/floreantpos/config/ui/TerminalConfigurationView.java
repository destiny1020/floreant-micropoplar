...
public class TerminalConfigurationView extends ConfigurationView {
  ...
  private void initComponents() {
    ...
    JLabel lblTerminalNumber =
        new JLabel(Messages.getString("TerminalConfigurationView.TERMINAL_NUMBER")); //$NON-NLS-1$
  ...
  public boolean save() {
    ...
    TerminalConfig
        .setAutoLogoffTime(tfLogoffTime.getInteger() <= 0 ? 10 : tfLogoffTime.getInteger());
