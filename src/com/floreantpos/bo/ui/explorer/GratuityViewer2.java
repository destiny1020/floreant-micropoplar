...
/**
 * Created by IntelliJ IDEA. User: mshahriar Date: Feb 19, 2007 Time: 12:06:24 AM To change this
  ...
  private void $$$setupUI$$$() {
    ...
    contentPane.add(cbUsers,
        new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST,
            ...
            GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(406, 22), null, 0, false));
    btnGo = new JButton();
    ...
    contentPane.add(separator1,
        new GridConstraints(1, 0, 1, 3, GridConstraints.ANCHOR_NORTH,
    ...
    contentPane.add(lblUserId,
        new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
            ...
            new Dimension(406, 14), null, 0, false));
    ...
    contentPane.add(lblTotalGratuity,
    ...
    contentPane.add(separator2,
        new GridConstraints(5, 1, 1, 2, GridConstraints.ANCHOR_CENTER,
            GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW,
            GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    ...
    contentPane.add(separator3,
        new GridConstraints(7, 0, 1, 3, GridConstraints.ANCHOR_SOUTH,
            GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW,
            GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    btnPay = new JButton();
    ...
    if (com.floreantpos.POSConstants.PAY.equalsIgnoreCase(actionCommand)) {
      try {
        ...
        ActionHistoryDAO.getInstance().saveHistory(Application.getCurrentUser(),
            ActionHistory.PAY_TIPS, actionMessage);
