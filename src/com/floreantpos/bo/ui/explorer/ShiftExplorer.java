...
public class ShiftExplorer extends TransparentPanel {
    ...
    deleteButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        try {
          ...
          if (ConfirmDeleteDialog.showMessage(ShiftExplorer.this,
  ...
  class ShiftTableModel extends ListTableModel {
    ...
    ShiftTableModel(List list) {
      super(
          new String[] {com.floreantpos.POSConstants.ID, com.floreantpos.POSConstants.NAME,
              com.floreantpos.POSConstants.START_TIME, com.floreantpos.POSConstants.END_TIME},
          list);
    }
