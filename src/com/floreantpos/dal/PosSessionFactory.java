...
public class PosSessionFactory {
  ...
  /**
   * Location of hibernate.cfg.xml file. NOTICE: Location should be on the classpath as Hibernate
   * uses #resourceAsStream style lookup for its configuration file. That is place the config file
   * in a Java package - the default location is the default Java package.<br>
   * <br>
   * Examples: <br>
