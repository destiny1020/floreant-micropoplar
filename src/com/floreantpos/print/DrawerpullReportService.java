...
public class DrawerpullReportService {
  ...
  public static DrawerPullReport buildDrawerPullReport() throws Exception {
    ...
    try {
      ...
      RefundSummary refundSummary =
          RefundTransactionDAO.getInstance().getTotalRefundForTerminal(terminal);
      ...
      // criteria.add(Restrictions.eq(GiftCertificateTransaction.PROP_DRAWER_RESETTED,
      // Boolean.FALSE));
  ...
  private static void populateVoidSection(Session session, Terminal terminal,
      DrawerPullReport report) {
    // void
    Criteria criteria = session.createCriteria(Ticket.class, "t");
  ...
  private static void populateNetSales(Session session, Terminal terminal,
      DrawerPullReport report) {
    // find net sale, tax
  ...
  private static void populateReceiptDifferential(Session session, Terminal terminal,
      DrawerPullReport report) {
    // find net sale, tax
    Criteria criteria = session.createCriteria(Ticket.class);
    criteria.add(Restrictions.eq(Ticket.PROP_PAID, Boolean.TRUE));
  ...
  private static TransactionSummary calculateTransactionSummary(Ticket ticket,
