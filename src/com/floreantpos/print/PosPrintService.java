...
public class PosPrintService {
  ...
  static void printMultilineColumn(PosPrinter printer, String text, int previoisColumnLength,
      int columnLength, boolean padLeft) {
    if (text.length() < columnLength) {
      if (padLeft) {
  ...
  static void printSecondColumn(PosPrinter printer, String text, int firstColumnLength,
      int secondColumnLength, boolean padLeft) {
  ...
  public static void printVoidInfo(Ticket ticket) throws Exception {
    ...
    //
    // posPrinter = new PosPrinter(PrintConfig.getJavaPosKitchenPrinterName(),
  ...
  public static void printDrawerPullReport(DrawerPullReport drawerPullReport, Terminal terminal) {
    ...
    try {
      ...
      JasperReport subReport = (JasperReport) JRLoader.loadObject(JReportPrintService.class
          .getResourceAsStream("/com/floreantpos/report/template/DrawerPullVoidReport.jasper"));

      parameters.put("subreportParameter", subReport);

      JasperReport mainReport = (JasperReport) JRLoader.loadObject(JReportPrintService.class
          .getResourceAsStream("/com/floreantpos/report/template/DrawerPullJReport.jasper"));
      JRBeanCollectionDataSource dataSource =
          new JRBeanCollectionDataSource(Arrays.asList(new DrawerPullReport[] {drawerPullReport}));
  ...
  public static void printServerTipsReport(TipsCashoutReport report) {
    ...
    try {
      ...
      parameters.put("transactionCount",
          report.getDatas() == null ? "0" : "" + report.getDatas().size());
      ...
      JasperReport mainReport = (JasperReport) JRLoader.loadObject(JReportPrintService.class
          .getResourceAsStream("/com/floreantpos/report/template/ServerTipsReport.jasper"));
      JRDataSource dataSource =
          new JRTableModelDataSource(new TipsCashoutReportTableModel(report.getDatas(),
              new String[] {"ticketId", "saleType", "ticketTotal", "tips"}));
      JasperPrint jasperPrint = JasperFillManager.fillReport(mainReport, parameters, dataSource);
