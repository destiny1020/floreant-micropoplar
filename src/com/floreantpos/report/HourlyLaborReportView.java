...
public class HourlyLaborReportView extends TransparentPanel {
  ...
  public HourlyLaborReportView() {
    cbUserType.setModel(new DefaultComboBoxModel(
        new String[] {com.floreantpos.POSConstants.ALL, com.floreantpos.POSConstants.SERVER,
            com.floreantpos.POSConstants.CASHIER, com.floreantpos.POSConstants.MANAGER}));
  ...
  private void viewReport() {
    ...
    for (int i = 0; i < 24; i++) {
      List<Ticket> tickets =
          ticketDAO.findTicketsForLaborHour(fromDate, toDate, i, userType, terminal);
      List<User> users = attendenceHistoryDAO.findNumberOfClockedInUserAtHour(fromDate, toDate, i,
          userType, terminal);
    ...
    for (Shift shift : shifts) {
      List<Ticket> tickets =
          ticketDAO.findTicketsForShift(fromDate, toDate, shift, userType, terminal);
      List<User> users = attendenceHistoryDAO.findNumberOfClockedInUserAtShift(fromDate, toDate,
          shift, userType, terminal);
    ...
    try {
      JasperReport hourlyReport = (JasperReport) JRLoader.loadObject(
          getClass().getResource("/com/floreantpos/report/template/hourly_labor_subreport.jasper"));
      JasperReport shiftReport = (JasperReport) JRLoader.loadObject(getClass()
          .getResource("/com/floreantpos/report/template/hourly_labor_shift_subreport.jasper"));

      JasperReport report = (JasperReport) JRLoader.loadObject(
          getClass().getResource("/com/floreantpos/report/template/hourly_labor_report.jasper"));
      ...
      properties.put(com.floreantpos.POSConstants.TYPE,
          com.floreantpos.POSConstants.BY_RANGE_ACTUAL);
      properties.put("dept", userType == null ? com.floreantpos.POSConstants.ALL : userType);
      properties.put("incr", "60 Minute");
      properties.put("cntr",
          terminal == null ? com.floreantpos.POSConstants.ALL : terminal.getName());
      ...
      properties.put("hourlyReportDatasource",
          new JRTableModelDataSource(new HourlyLaborReportModel(rows)));
      properties.put("shiftReport", shiftReport);
      properties.put("shiftReportDatasource",
          new JRTableModelDataSource(new HourlyLaborReportModel(shiftReportRows)));
  ...
  private void $$$setupUI$$$() {
    ...
    panel1.add(cbTerminal,
        new GridConstraints(3, 1, 1, 1, GridConstraints.ANCHOR_WEST,
            GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW,
            GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(147, 22), null, 0, false));
    btnGo = new JButton();
    btnGo.setText(com.floreantpos.POSConstants.GO);
    panel1.add(btnGo,
        new GridConstraints(4, 1, 1, 1, GridConstraints.ANCHOR_EAST, GridConstraints.FILL_NONE, 1,
            GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(147, 23), null, 0, false));
    ...
    panel1.add(cbUserType,
        new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST,
            GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW,
            GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(147, 22), null, 0, false));
    final JSeparator separator1 = new JSeparator();
    panel1.add(separator1,
        new GridConstraints(5, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
