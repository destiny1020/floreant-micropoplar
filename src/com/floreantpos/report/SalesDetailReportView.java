...
public class SalesDetailReportView extends JPanel {
  ...
  private void viewReport() throws Exception {
    ...
    JasperReport drawerPullReport = (JasperReport) JRLoader.loadObject(SalesReportModelFactory.class
        .getResource("/com/floreantpos/report/template/sales_summary_balance_detailed__1.jasper"));
    JasperReport creditCardReport = (JasperReport) JRLoader.loadObject(SalesReportModelFactory.class
        .getResource("/com/floreantpos/report/template/sales_summary_balance_detailed_2.jasper"));
    ...
    map.put("drawerPullDatasource",
        new JRTableModelDataSource(report.getDrawerPullDataTableModel()));
    map.put("creditCardReport", creditCardReport);
    map.put("creditCardReportDatasource",
        new JRTableModelDataSource(report.getCreditCardDataTableModel()));

    JasperReport jasperReport = (JasperReport) JRLoader.loadObject(getClass()
        .getResource("/com/floreantpos/report/template/sales_summary_balace_detail.jasper"));
