...
public class CreditCardReportView extends JPanel {
  ...
  private void viewReport() throws Exception {
    ...
    List<CreditCardTransaction> transactions = (List<CreditCardTransaction>) PosTransactionDAO
        .getInstance().findTransactions(null, CreditCardTransaction.class, fromDate, toDate);
    ...
    JasperReport jasperReport = (JasperReport) JRLoader.loadObject(
        getClass().getResource("/com/floreantpos/report/template/credit_card_report.jasper"));
    JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, map,
        new JRTableModelDataSource(new CardReportModel(transactions)));
