...
public class SalesExceptionReport {
  ...
  public void addVoidToVoidData(Ticket ticket) {
    ...
    /*
     * boolean found = false; for (VoidData voidData : voidedTickets) { if
     * (voidData.getReasonCode().equalsIgnoreCase(voidReason)) {
     * voidData.setCount(voidData.getCount() + 1); voidData.setAmount(voidData.getAmount() +
     * amount); found = true; break; } }
     */
    // if (!found) {
