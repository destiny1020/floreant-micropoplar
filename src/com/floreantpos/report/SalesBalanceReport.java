...
public class SalesBalanceReport {
  ...
  public void calculate() {
    ...
    receiptDiffAmount = grossReceiptsAmount - cashReceiptsAmount - creditCardReceiptsAmount
        - arReceiptsAmount - giftCertReturnAmount + giftCertChangeAmount + cashBackAmount;
    cashAccountableAmount = cashReceiptsAmount - grossTipsPaidAmount + tipsDiscountAmount
        - cashPayoutAmount - giftCertChangeAmount - cashBackAmount;
    overShortAmount =
        cashAccountableAmount - drawerPullsAmount - coCurrentAmount + coPreviousAmount;
