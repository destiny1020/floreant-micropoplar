...
public class SalesAnalysisReportModel extends ListTableModel {
  ...
  public SalesAnalysisReportModel(List<SalesAnalysisData> dataList) {
    super(new String[] {"shiftName", "categoryName", "count", "gross", "discount", "netSales",
        "avgGross", "avgDiscount", "avgNet", "percentage"}, dataList);
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    JasperReport report = (JasperReport) JRLoader.loadObject(SalesAnalysisData.class
        .getResource("/com/floreantpos/report/template/sales_summary_report2.jasper"));
    JasperPrint print =
        JasperFillManager.fillReport(report, new HashMap(), new JRBeanCollectionDataSource(list));
