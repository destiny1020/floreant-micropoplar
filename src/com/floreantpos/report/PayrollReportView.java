...
public class PayrollReportView extends TransparentPanel {
  ...
  public PayrollReportView() {
    // cbUserType.setModel(new DefaultComboBoxModel(new String[]{com.floreantpos.POSConstants.ALL,
    // com.floreantpos.POSConstants.SERVER, com.floreantpos.POSConstants.CASHIER,
  ...
  private void viewReport() {
    ...
    /*
     * String userType = (String) cbUserType.getSelectedItem(); if
     * (userType.equalsIgnoreCase(com.floreantpos.POSConstants.ALL)) { userType = null; } Terminal
     * terminal = null; if (cbTerminal.getSelectedItem() instanceof Terminal) { terminal =
     * (Terminal) cbTerminal.getSelectedItem(); }
     */
    ...
    try {
      JasperReport report = (JasperReport) JRLoader.loadObject(
          getClass().getResource("/com/floreantpos/report/template/PayrollReport.jasper"));
      ...
      JasperPrint print =
          JasperFillManager.fillReport(report, properties, new JRTableModelDataSource(reportModel));
  ...
  private void $$$setupUI$$$() {
    ...
    // panel1.add(label3, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_WEST,
    ...
    // panel1.add(cbTerminal, new GridConstraints(3, 1, 1, 1, GridConstraints.ANCHOR_WEST,
    ...
    // panel1.add(label4, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST,
    // GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED,
    // GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    // cbUserType = new JComboBox();
    // panel1.add(cbUserType, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST,
    // GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW,
    // GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(147, 22), null, 0, false));
