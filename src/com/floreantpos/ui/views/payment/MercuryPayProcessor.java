...
public class MercuryPayProcessor implements CardProcessor {
  ...
  private String doPreAuth(Ticket ticket, String cardTrack, double amount)
    ...
    String xml = StreamUtils.toString(
        MercuryPayProcessor.class.getResourceAsStream("/com/mercurypay/ws/sdk/mercuryAuth.xml"));
    ...
    mpswr.addParameter("tran", xml); // Set WebServices 'tran' parameter to the XML transaction
                                     // request
  ...
  @Override
  public String authorizeAmount(Ticket ticket, String cardTrack, double amount, String cardType)
      throws Exception {
  ...
  public void captureAuthorizedAmount(PosTransaction transaction) throws Exception {
    String xml = StreamUtils.toString(MercuryPayProcessor.class
        .getResourceAsStream("/com/mercurypay/ws/sdk/mercuryPreAuthCapture.xml"));
    Ticket ticket = transaction.getTicket();
