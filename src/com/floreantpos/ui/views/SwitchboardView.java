...
public class SwitchboardView extends JPanel implements ActionListener, ITicketList {
  ...
  private void initComponents() {
    ...
    bottomLeftPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
        POSConstants.OPEN_TICKETS_AND_ACTIVITY, javax.swing.border.TitledBorder.CENTER,
    ...
    bottomRightPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "系统功能",
    ...
    bottomRightPanel.setLayout(
        new MigLayout("aligny bottom, insets 1 2 1 2, gapy 10", "[140px]", "[][][][][]"));
  ...
  protected void doAssignDriver() {
    try {
      ...
      if (assignedDriver != null) {
        int option = JOptionPane.showOptionDialog(Application.getPosWindow(),
            "Driver already assigned. Do you want to reassign?", "Confirm",
    ...
    try {
      ...
      if (ticket == null) {
        throw new PosException(
            POSConstants.NO_TICKET_WITH_ID + " " + ticketUniqId + " " + POSConstants.FOUND);
      }
      ...
      // String amountMessage = "<span style='color: red; font-weight: bold;'>" + ticketTotalAmount
      // + "</span>";
      // String message = "<html><body>Ticket amount is " + ticketTotalAmount
      // + ". To reopen ticket, you need to refund that amount to system.<br/>Please press <b>OK</b>
      // after you refund amount " + amountMessage
      // + "</body></html>";
      //
  ...
  private void doClockOut() {
    int option =
        JOptionPane.showOptionDialog(this, POSConstants.CONFIRM_CLOCK_OUT, POSConstants.CONFIRM,
            JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
    if (option != JOptionPane.YES_OPTION) {
      return;
    }
  ...
  private void doCreateNewTicket(final TicketType ticketType) {
    try {
      ...
      int option = JOptionPane.showOptionDialog(Application.getPosWindow(),
          POSConstants.EDIT_TICKET_CONFIRMATION, POSConstants.CONFIRM, JOptionPane.YES_NO_OPTION,
  ...
  public void updateTicketList() {
    ...
    lblUserName.setText(POSConstants.WELCOME + " " + user.toString() + "." + POSConstants.YOU
        + POSConstants.HAVE + " " + openTickets.size() + "个 " + POSConstants.OPEN.toLowerCase()
        + "的" + POSConstants.TICKETS + ".");
  }
