...
public class TicketView extends JPanel {
	...
	private void initComponents() {
		...
		ticketAmountPanel.add(lblCustomerPhone, "cell 0 0,growx,aligny center");
		...
		// ticketAmountPanel.add(tfServiceCharge, "cell 1 4,growx,aligny
		// center");
		...
		// chkTaxExempt.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
		// 0, 0, 0));
	...
	public void updateView() {
		if (ticket == null) {
			...
			setBorder(BorderFactory.createTitledBorder(null, "订单 [ 新建 ]", TitledBorder.CENTER,
