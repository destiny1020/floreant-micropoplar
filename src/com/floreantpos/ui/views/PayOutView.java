...
public class PayOutView extends TransparentPanel {
  ...
  private void initComponents() {
    ...
    layout.setHorizontalGroup(layout.createParallelGroup(Alignment.LEADING)
        .addGroup(layout.createSequentialGroup().addContainerGap()
            .addComponent(numberSelectionView, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                GroupLayout.PREFERRED_SIZE)
            .addGap(7)
            .addGroup(layout.createParallelGroup(Alignment.TRAILING)
                .addGroup(layout.createSequentialGroup()
                    .addComponent(cbRecepient, 0, 349, Short.MAX_VALUE)
                    .addPreferredGap(ComponentPlacement.RELATED).addComponent(btnNewRecepient,
                        GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE))
            .addGroup(layout.createSequentialGroup().addComponent(cbReason, 0, 334, Short.MAX_VALUE)
                .addPreferredGap(ComponentPlacement.RELATED).addComponent(btnNewReason,
                    GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                    GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(ComponentPlacement.RELATED).addComponent(btnAddNote,
            ...
            layout.createParallelGroup(Alignment.LEADING)
                .addGroup(layout.createSequentialGroup().addContainerGap()
                    .addGroup(layout.createParallelGroup(Alignment.LEADING)
                        .addComponent(numberSelectionView, GroupLayout.DEFAULT_SIZE, 380,
                            Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup().addComponent(jLabel1)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup().addGap(4).addComponent(
                                cbReason, GroupLayout.DEFAULT_SIZE, 41, Short.MAX_VALUE))
                        .addComponent(btnNewReason, GroupLayout.PREFERRED_SIZE,
                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                        .addGap(33).addComponent(jLabel2)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(cbRecepient, GroupLayout.DEFAULT_SIZE, 41,
                                    Short.MAX_VALUE)
                                .addGap(4))
                            .addComponent(btnNewRecepient, GroupLayout.PREFERRED_SIZE,
                                GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                        .addGap(31).addComponent(jLabel3)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(Alignment.LEADING)
                            .addComponent(btnAddNote, GroupLayout.PREFERRED_SIZE, 46,
                                GroupLayout.PREFERRED_SIZE)
                            .addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 142,
                                Short.MAX_VALUE))))
                    .addContainerGap()));
  ...
  protected void doNewRecepient() {
    ...
    DefaultComboBoxModel<PayoutRecepient> model =
        (DefaultComboBoxModel<PayoutRecepient>) cbRecepient.getModel();
  ...
  protected void doNewReason() {
    ...
    DefaultComboBoxModel<PayoutReason> model =
        (DefaultComboBoxModel<PayoutReason>) cbReason.getModel();
