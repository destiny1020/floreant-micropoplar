...
public class TicketItemRowCreator {
  ...
  // public static void calculateKitchenTicketRows(KitchenTicket ticket, Map<String, ITicketItem>
  // tableRows) {
  // tableRows.clear();
  //
  // int rowNum = 0;
  ...
  private static int includeModifiers(TicketItem ticketItem, Map<String, ITicketItem> tableRows,
      int rowNum, boolean kitchenPrint) {
      ...
      for (TicketItemModifierGroup ticketItemModifierGroup : ticketItemModifierGroups) {
        ...
        if (ticketItemModifiers != null) {
          for (TicketItemModifier itemModifier : ticketItemModifiers) {
            ...
            if (kitchenPrint
                && (itemModifier.isPrintedToKitchen() || !itemModifier.isShouldPrintToKitchen())) {
              continue;
            }
