...
public class TipsCashoutReportDialog extends POSDialog implements ActionListener {
  ...
  public TipsCashoutReportDialog(TipsCashoutReport report, JDialog parent, boolean modal) {
    ...
    topPanel.add(new JLabel(": " + DateUtil.getReceiptDate(report.getFromDate())), "wrap");
    topPanel.add(new JLabel("To"));
    topPanel.add(new JLabel(": " + DateUtil.getReceiptDate(report.getToDate())), "wrap");
    topPanel.add(new JLabel("Time"));
    topPanel.add(new JLabel(": " + DateUtil.getReceiptDate(report.getReportTime())), "wrap");
    topPanel.add(new JLabel("Transaction Count"));
    topPanel.add(
        new JLabel(
            ": " + (report.getDatas() == null ? "0" : String.valueOf(report.getDatas().size()))),
        "wrap");
