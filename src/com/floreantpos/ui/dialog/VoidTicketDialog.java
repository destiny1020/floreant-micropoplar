...
public class VoidTicketDialog extends POSDialog {
  ...
  private void initComponents() {
    ...
    org.jdesktop.layout.GroupLayout transparentPanel2Layout =
        new org.jdesktop.layout.GroupLayout(transparentPanel2);
    ...
    transparentPanel2Layout
        .setHorizontalGroup(
            transparentPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(transparentPanel2Layout.createSequentialGroup().add(jLabel1)
                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                    .add(transparentPanel2Layout
                        .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(chkItemsWasted)
                        .add(org.jdesktop.layout.GroupLayout.TRAILING, transparentPanel2Layout
                            .createSequentialGroup().add(cbVoidReasons, 0, 0, Short.MAX_VALUE)
                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                            .add(btnNewVoidReason, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                79, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
            .addContainerGap()));
    transparentPanel2Layout
        .setVerticalGroup(
            transparentPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(transparentPanel2Layout.createSequentialGroup().addContainerGap()
                    .add(transparentPanel2Layout
                        .createParallelGroup(
                        ...
                        .add(org.jdesktop.layout.GroupLayout.TRAILING, transparentPanel2Layout
                            ...
                            .add(transparentPanel2Layout
                                ...
                                .add(jLabel1).add(cbVoidReasons,
                                    org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 20,
                                    Short.MAX_VALUE))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(chkItemsWasted).add(34, 34, 34))
                .add(transparentPanel2Layout.createSequentialGroup()
                    .add(btnNewVoidReason, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
    ...
    btnVoid
        .setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/void_ticket_32.png"))); // NOI18N
  ...
  private void btnVoidActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnVoidActionPerformed
    try {
      ...
      try {
        ...
        additionalCtx.put("time",
            POSConstants.RECEIPT_REPORT_VOID_TIME_LABEL + DateUtil.getReceiptDateTime(new Date()));
        additionalCtx.put("operator",
            POSConstants.RECEIPT_REPORT_OPERATOR_LABEL + ticket.getVoidedBy());
        ...
        additionalCtx.put("optional1",
            POSConstants.RECEIPT_REPORT_VOID_REASON_LABEL + voidReasonStr);

        String wastedStr = ticket.isWasted() ? POSConstants.RECEIPT_REPORT_VOID_WASTED_YES
            : POSConstants.RECEIPT_REPORT_VOID_WASTED_NO;
      ...
      ActionHistoryDAO.getInstance().saveHistory(Application.getCurrentUser(),
          ...
          com.floreantpos.POSConstants.RECEIPT_REPORT_TICKET_NO_LABEL + ":" + ticket.getId()
              + "; Total" + ": " + NumberUtil.formatNumber(ticket.getTotalAmount()));
